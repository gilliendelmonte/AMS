          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 10%;"> Date of Purchase </th>
                <th class="text-center" style="width: 10%;"> Store Location</th>
                <th class="text-center" style="width: 10%;"> Date of Warranty </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['units']); ?></td>
